# -*- coding: utf-8 -*-
"""
로컬 실행용 — HYOSUNG ITX 공통템플릿(16x9) 기반 발표자료 생성

사용법:
  1) pip install python-pptx lxml
  2) 이 .py 파일과 같은 폴더에 회사 템플릿을 둠
       2025_공통템플릿(16x9).pptx  또는  2025_공통템플릿_16x9.pptx
  3) python build_pptx_local.py
  4) 같은 폴더에 AI_활용_생산성_발표자료.pptx 생성
"""
...
OUT = HERE / 'AI_활용_생산성_발표자료.pptx'
_CANDIDATES = [
    HERE / '2025_공통템플릿_16x9.pptx',
    HERE / '2025_공통템플릿(16x9).pptx',
    HERE / 'templates' / '2025_공통템플릿_16x9.pptx',
]
TEMPLATE = next((p for p in _CANDIDATES if p.exists()), None)
if TEMPLATE is None:
    raise SystemExit(
        '[오류] HYOSUNG ITX 공통템플릿 PPTX를 찾을 수 없습니다.\n'
        '이 스크립트와 같은 폴더에 아래 파일 중 하나를 두세요.\n'
        '  - 2025_공통템플릿_16x9.pptx\n'
        '  - 2025_공통템플릿(16x9).pptx'
    )
