...
<section>
  <h2>1. 핵심 수치</h2>
  <div class="kpi">
    <div class="item"><div class="v">105</div><div class="l">총 질문<br/>(메타·복붙 제외)</div></div>
    <div class="item"><div class="v">23</div><div class="l">오류 관련<br/>(중복 제거)</div></div>
    <div class="item"><div class="v">13–15</div><div class="l">기능 수정<br/>(중복 제거)</div></div>
    <div class="item"><div class="v">54 / 55</div><div class="l">최종 Parity<br/>A / B (만점 56)</div></div>
  </div>
  <p class="note">집계 세션: A Awesome skills automation + B 통합 운영 모니터링 대시보드. 전사가 열리지 않은 세션(SELECT-OPTIONS 등)은 미포함.</p>
</section>
  ...
  <div class="grid2">
    <div class="card">
      ...
      <ul>
        ...
        <li>E_compile ≈ 18+</li>
        <li>최종 Parity <strong>54</strong></li>
    ...
    <div class="card">
      ...
      <ul>
        ...
        <li>E_compile = 2</li>
        <li>최종 Parity <strong>55</strong></li>
...
<section>
  <h2>5. Parity 채점 · 최종</h2>
  <div class="card">
    <p>만점 56 = S1 기능 20 + S2 안전 12 + S3 UX 16 + S4 전달 8. 항목 0/1/2.</p>
    <p><strong>Hard Gate:</strong> 활성화 실패 · 빈 화면 · 팝업 미동작 · 필수 조회 0건 버그 · 드릴다운 불능이면 PASS 불가. 코드만·미실기면 Total 상한 40.</p>
  </div>
  <table>
    <tr><th>섹션</th><th class="num">A</th><th class="num">B</th></tr>
    <tr><td>S1 기능</td><td class="num">20</td><td class="num">20</td></tr>
    <tr><td>S2 안전</td><td class="num">12</td><td class="num">12</td></tr>
    <tr><td>S3 UX</td><td class="num">16</td><td class="num">15</td></tr>
    <tr><td>S4 전달</td><td class="num">6</td><td class="num">8</td></tr>
    <tr><td><strong>총점</strong></td><td class="num"><strong>54</strong> <span class="tag pass">PASS</span></td><td class="num"><strong>55</strong> <span class="tag pass">PASS</span></td></tr>
  </table>
</section>

<section>
  <h2>6. 질문 수별 품질 추이</h2>
  <p>가로축: 공정 누적 질문 <code>cum_Q_program</code> (PPT·소스복붙·메타 제외). 세로축: Parity Total / 56. 중간값은 마일스톤 추정(±2), 최종행은 공식 채점.</p>
...
<section>
  ...
  <p>최종 품질은 유사(54 vs 55). PASS 도달 속도는 B가 뚜렷. “B가 처음부터 실기까지 완벽”은 아님 - 첫 PASS는 Q≈12.</p>
</section>
...
<section>
  ...
  <div class="card">
    <ol>
      <li><strong>품질:</strong> A=54, B=55 (Δ=1) - Hard Gate 적용 기준 동등.</li>
