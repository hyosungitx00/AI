...
<section>
  ...
  <table>
    ...
    <tr>
      <td>최종 Parity</td>
      <td>설계·UX 바 대비 품질 점수<br/>(만점 56, PASS ≥ 50)</td>
      <td class="num"><strong>54</strong> <span class="tag pass">PASS</span></td>
      <td class="num"><strong>55</strong> <span class="tag pass">PASS</span></td>
    </tr>
    <tr>
      <td>E_compile</td>
  ...
  <p class="note">품질(54 vs 55)은 거의 같고, PASS 도달(57→12)·컴파일 오류 왕복(~18+→2)은 B가 적음. 전사가 열리지 않은 세션은 비교에 미포함.</p>
</section>
